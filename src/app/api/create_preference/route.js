...
export async function POST(request) {
  try {
    ...
    const body = {
      ...
      back_urls: {
        success: "https://d0jvt1bv-3000.brs.devtunnels.ms/user",
        failure: "https://d0jvt1bv-3000.brs.devtunnels.ms/user",
        pending: "https://d0jvt1bv-3000.brs.devtunnels.ms/user",
      },

...
import { Clock, Calendar, ArrowRight, Share2, ArrowLeft, X } from 'lucide-react';
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="min-h-screen bg-white rounded-t-[2rem] overflow-hidden"
        ...
        >
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <motion.div
              className="relative h-[200px] sm:h-[300px] lg:h-[400px] mb-8 rounded-2xl overflow-hidden"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}

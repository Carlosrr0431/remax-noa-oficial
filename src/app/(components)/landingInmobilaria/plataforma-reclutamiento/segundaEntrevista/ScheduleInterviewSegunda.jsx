...
export default function ScheduleInterviewSegunda({ onSchedule, userSelect }) {
    ...
    return (
        <Card className="w-full max-w-md mx-auto h-full sm:max-w-xl relative">
            <CardHeader>
                <CardTitle className="text-xl sm:text-2xl font-bold text-center text-primary">Programa tu Entrevista Individual</CardTitle>
            </CardHeader>
            <CardContent>

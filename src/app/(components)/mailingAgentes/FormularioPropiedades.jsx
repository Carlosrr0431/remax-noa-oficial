...
export default function FormularioPropiedades({ agente }) {
    ...
    const establecerFecha = (fecha1) => {
        ...
        if (fecha1 != null) {
            ...
            // let fechaActualizada = moment(fecha1.split('/').reverse().join('/'))

            // console.log("fecha actualizada: " + fechaActualizada);

            // return Math.abs(fecha2.diff(fechaActualizada, 'days'))
        } else
            return 1
    }
        ...
        <div className="max-w-2xl mx-auto p-6">
            {
                ...
                </div> : (<div>     <Card className="w-full max-w-md mx-auto">
                    <CardHeader>
                        <CardTitle className="text-2xl font-bold text-red-600">Límite Diario Excedido</CardTitle>
                        <CardDescription>Has alcanzado el máximo de correos enviados por hoy</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <Alert variant="destructive">
                            ...
                            <AlertDescription>
                                Has excedido el límite de correos electrónicos que puedes enviar en un día. Por favor, espera hasta mañana para enviar más correos.
                            </AlertDescription>
                        </Alert>
                    </CardContent>

...
const Header = () => {
  ...
  return (
    ...
    <div  >
      <header className={`${pathname == '/user' || pathname == '/ranking' || pathname == '/cursos' || pathname == '/contactanos' || pathname == '/mailingSystem' || pathname == '/inventarioRemax' || pathname == '/dashboard/administrador' || pathname == '/dashboard' || pathname == '/dashboard/jujuy' || pathname == '/dashboard/rrhh' || pathname == '/mailingSystem/rrhh'  || pathname == '/comunidadRemax' || pathname == '/mailingSystem/agentes' || pathname == '/eventos' || pathname == '/comunidadRemax'  || pathname == '/login' ? 'hidden' : ''} absolute  z-50  w-full flex items-center   xl:h-[100px]`}>

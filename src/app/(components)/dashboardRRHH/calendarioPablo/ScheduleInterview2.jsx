...
export default function ScheduleInterview2({ onSchedule, setSchedulingUser, userSelect }) {
  ...
  return (
    <Card className="w-full max-w-md mx-auto h-full sm:max-w-xl relative">
      <CardHeader>
        <CardTitle className="text-xl sm:text-2xl font-bold text-center text-primary">Programa la 3ra Entrevista
        </CardTitle>

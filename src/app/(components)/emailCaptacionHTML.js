...
.benefit-icon {
  ...
  <body style="word-spacing:normal;">
      ...
      >Estimado/a <span data-variable="nombre"></span>,</div>
      ...
      <div
         style="font-family:Roboto, Arial, sans-serif;font-size:18px;line-height:1;text-align:center;color:#333333;"
      >¿Tienes preguntas? ¡Contáctanos directamente!</div>
      ...
      <div
         style="font-family:Roboto, Arial, sans-serif;font-size:14px;line-height:1;text-align:center;color:#ffffff;"
      ><span data-variable="nombre_agencia">RE/MAX NOA </span> - Tu puerta al éxito en bienes raíces</div>

...
const WhatsApp = () => {
    ...
    return (
        ...
        <div className={`${pathname == '/dashboard' || pathname == '/contactanos' || pathname == '/dashboard/administrador' || pathname == '/dashboard/jujuy' || pathname == '/login' || pathname == '/mailingSystem' || pathname == '/mailingSystem/rrhh' || pathname == '/ranking'  || pathname == '/dashboard/rrhh' || pathname == '/mailingSystem/agentes' ? 'hidden' : 'block'} `}>
            <Link
